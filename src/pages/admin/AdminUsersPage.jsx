...
function UserBlockConfirm(props) {
    ...
    return <div className="fixed left-0 top-0 w-full h-screen bg-[#00000050] z-[100] flex justify-center items-center">
        <div className="w-[500px] h-[200px] bg-primary relative flex flex-col justify-center items-center gap-[40px]">
            <button onClick={close} className="absolute right-[-40px] top-[-40px] w-[40px] h-[40px] bg-red-600 rounded-full text-white flex justify-center items-center font-bold border-red-600 hover:bg-white hover:text-red-600">
                X
            </button>
            ...
            <div className="flex gap-[40px]">
                <button onClick={close} className="w-[100px] bg-blue-600 p-[5px] text-white hover:bg-blue-900">
                    Cancel
                </button>
                <button onClick={blockUser} className="w-[100px] bg-red-600 p-[5px] text-white hover:bg-red-900">
                    Yes
                </button>
            </div>
        </div>
            ...
            <div className="mx-auto max-w-7xl p-6">
                ...
                <div className="rounded-2xl border border-secondary/10 bg-primary shadow-sm">
                    ...
                    <div className="overflow-x-auto">
                        {isLoading ? <p><Loader /></p> : <table className="w-full min-w-[880px] text-left">
                                        ...
                                        >
                                            <td className="px-4 py-3">
                                                <img
                                                    ...
                                                    alt={user.firstName}
                                                    className={"h-16 w-16 rounded-full object-cover border-4 " + (user.isBlock ? " border-red-600" : "border-green-600")}
                                                />
                                            </td>
